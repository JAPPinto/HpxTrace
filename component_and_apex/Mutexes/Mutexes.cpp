...
HPX_REGISTER_ACTION( MutexesServer_type::wrapped_type::lock_action, MutexesServer_lock_action);
HPX_REGISTER_ACTION( MutexesServer_type::wrapped_type::unlock_action, MutexesServer_unlock_action);
