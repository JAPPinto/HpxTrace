...
namespace server{
	class comp : public hpx::components::locking_hook< hpx::components::component_base<comp> >, public monitor{
		...
		public:
			...
			HPX_DEFINE_COMPONENT_ACTION(comp, read);
	};
}
...
HPX_REGISTER_ACTION_DECLARATION( server::comp::read_action, comp_read_action);
